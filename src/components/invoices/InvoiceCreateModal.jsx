...
export default function InvoiceCreateModal({ 
  ...
  const handleGenerateInvoiceNumber = () => {
    ...
    const generated = `INV-${year}-${random}`
    setFormData({ ...formData, invoice_number: generated })
  ...
  const handleSubmit = (e) => {
    ...
    if (!autoGenerate && !formData.invoice_number) {
      toast.error('Please enter an invoice number or use auto-generate')
      return
    }
    ...
    const submitData = {
      ...
      // If auto-generate, don't send invoice_number (API will generate)
      invoice_number: autoGenerate ? undefined : formData.invoice_number
    }
    ...
    <Dialog open={open} onOpenChange={setOpen}>
      <DialogContent className="bg-gray-900 border-white/10 text-white max-w-2xl max-h-[90vh] overflow-y-auto">
        ...
        <form onSubmit={handleSubmit} className="space-y-4">
          ...
          {/* Invoice Number */}
          <div className="space-y-2">
            <Label htmlFor="invoice_number" className="text-sm font-bold text-gray-400 uppercase">
              Invoice Number
            </Label>
            <div className="flex gap-2">
              <Input
                ...
                placeholder={autoGenerate ? "Will be auto-generated" : "Enter invoice number"}
            ...
            {autoGenerate && (
              <p className="text-xs text-gray-500">
                Invoice number will be auto-generated (e.g., INV-2026-0001)
              </p>
            )}
          </div>
