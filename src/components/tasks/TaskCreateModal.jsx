...
export default function TaskCreateModal({ open, setOpen, onSuccess }) {
  ...
  const [formData, setFormData] = useState({
    ...
    link_type: 'none', // none, lead, project
    lead_id: null,
    project_id: null,
    remarks: ''
  })
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      const taskData = {
        ...
        completed_date: formData.task_status === 'done' ? format(new Date(), 'yyyy-MM-dd') : null
      }
      ...
      <DialogContent className="bg-black/95 border-neon-blue/20 text-white backdrop-blur-2xl sm:max-w-[600px] max-h-[90vh] overflow-y-auto">
        ...
        <form onSubmit={handleSubmit} className="space-y-4 py-4">
          ...
          <div className="space-y-2">
            <Label htmlFor="employee" className="text-xs font-black uppercase text-gray-400">
              Assign To Employee *
            </Label>
            <Select 
            ...
            {errors.employee_id && <p className="text-xs text-red-400">{errors.employee_id}</p>}
          </div>
          ...
          {/* Scheduled Date */}
          <div className="space-y-2">
            <Label htmlFor="scheduled_date" className="text-xs font-black uppercase text-gray-400">
              Scheduled Date *
            </Label>
            <Input
              id="scheduled_date"
            ...
            />
            {errors.scheduled_date && <p className="text-xs text-red-400">{errors.scheduled_date}</p>}
          </div>
          ...
          {/* Remarks */}
          <div className="space-y-2">
            <Label htmlFor="remarks" className="text-xs font-black uppercase text-gray-400">
              Remarks / Notes
            </Label>
            <Textarea
              id="remarks"
          ...
          <DialogFooter className="gap-2">
            ...
            <Button
              type="submit"
              disabled={isLoading}
              className="bg-neon-blue text-black font-black uppercase tracking-widest hover:bg-neon-blue/80"
            >
